...
class VAE(nn.Module):
    def __init__(self):
        ...
        self.encoder_fc2 = nn.Linear(self.en_shape, nz)
        self.Sigmoid = nn.Sigmoid()
        self.decoder_fc = nn.Linear(nz + 64, self.en_shape)
    ...
    def decoder(self, z):
        ...
        out3 = out3.view(out3.shape[0], 32, 4, 3)
...
if __name__ == '__main__':
    ...
    print("=====> 构建C")
    C = Discriminator_C(64).to(device)
    ...
    for epoch in range(nepoch):
        for i, (data, label) in enumerate(dataloader, 0):
            ...
            z = torch.randn(batch_size, nz + 64).to(device)
            # print(z.shape)
